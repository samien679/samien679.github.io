...
},{"./css/tailwind.css":"sOqH8","alpinejs":"01CRF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"sOqH8":[function() {},{}],"01CRF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function onMutate(mutations) {
    ...
    for (let node2 of addedNodes){
        if (removedNodes.includes(node2)) continue;
        onElAddeds.forEach((i)=>i(node2)
        );
    }
...
function generateEvaluatorFromString(dataStack, expression, el) {
    ...
    return (receiver = ()=>{
        ...
        if (typeof func === "function") {
            ...
            if (func.finished) runIfTypeOfFunction(receiver, func.result, completeScope, params, el);
